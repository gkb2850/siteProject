<template>
  <div class="navbar" :style="{'background':color1}">
    ...
    <div class="right-menu">
      <el-dropdown class="change" trigger="click">
    ...
    <el-dialog title="余额充值" class="recharge-warp" :visible.sync="rechargeDialog">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="rechargeConfirm" :loading="loading">充 值</el-button>
      </span>
    ...
    <el-dialog title="资金明细" :visible.sync="moneyDialog" width="70%">
      <div class="filter-wrap">
        <span>订单编号：</span>
        <el-input v-model="moneyListSearch.orderID" placeholder="请输入订单编号" style="width:200px;"></el-input>
        <span style="margin-left:10px">商户号：</span>
        <el-input v-model="moneyListSearch.paySn" placeholder="请输入商户号" style="width:200px;"></el-input>
        ...
        <el-select
          v-model="moneyListSearch.transactionType"
          placeholder="请选择"
          clearable
          @clear="setValueNull()"
        >
        ...
        <el-button type="primary" icon="el-icon-search" @click="goFundDetails" :loading="loading">查询</el-button>
      </div>
      ...
      >
        ...
        <el-table-column :show-overflow-tooltip="true" prop="createTime" label="交易时间"></el-table-column>
    ...
    >
      ...
      <div class="order-type order-type3" v-show="orderType == 3">
        ...
        >
          ...
          <el-table-column :show-overflow-tooltip="true" prop="paySn" label="商户号"></el-table-column>
          <el-table-column :show-overflow-tooltip="true" prop="money" label="交易金额" width="100px"></el-table-column>
          <el-table-column
    ...
    <el-dialog title="修改密码" :visible.sync="pwdDialog" @closed="closePassword">
        <el-form :model="pwdForm" ref="pwdForm" :rules="pwdRules" label-width="100px" class="demo-dynamic">
            <el-form-item prop="oldPassword" label="原密码">
                <el-input v-model="pwdForm.oldPassword" type="password" placeholder="请输入原密码" style="max-width:350px"></el-input>
            </el-form-item>
            <el-form-item prop="password" label="新密码">
                <el-input v-model="pwdForm.password" type="password" placeholder="请输入新密码" style="max-width:350px"></el-input>
            </el-form-item>
            <el-form-item prop="repassword" label="确认密码">
                <el-input v-model="pwdForm.repassword" type="password" placeholder="请输入确认密码" style="max-width:350px"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click="changePWd()" :loading="loading">确 认 修 改</el-button>
            </el-form-item>
        </el-form>
