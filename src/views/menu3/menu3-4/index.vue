  ...
  <div class="container container-good">
    <div class="filter-wrap">
      ...
      <el-select v-model="form.type" placeholder="商品状态">
        <el-option label="商品状态" value="1"></el-option>
        <el-option label="销售" value="1"></el-option>
        <el-option label="暂停" value="2"></el-option>
        <el-option label="禁售" value="3"></el-option>
      </el-select>
      <el-select v-model="form.type" placeholder="全部目录状态">
        <el-option label="全部目录状态" value="1"></el-option>
        <el-option label="已设置" value="1"></el-option>
        <el-option label="未设置" value="2"></el-option>
      </el-select>
      <el-select v-model="form.type" placeholder="全部模板状态">
        <el-option label="全部模板状态" value="1"></el-option>
        <el-option label="已设置" value="1"></el-option>
        <el-option label="未设置" value="2"></el-option>
      </el-select>
    ...
    <el-table border row-key="id" ref="multipleTable" :data="tableData3" style="width: 100%"
      ...
      <el-table-column :show-overflow-tooltip="true" prop="goodsID" label="编号" align="center"
      ...
      <el-table-column :show-overflow-tooltip="true" prop="goodsPrice" label="成本价" align="center"></el-table-column>
      <el-table-column :show-overflow-tooltip="true" prop="supplyPrice" label="对接价" align="center"></el-table-column>
    ...
    <el-dialog title="商家信息" :visible.sync="businessInfoDialog" width="40%" class="dialog1">
      <ul class="businessInfoUl">
        <li>
          <span class="label">平台系统域名：</span>
          <span class="val">{{businessInfo.domainName}}</span>
        </li>
        <li>
