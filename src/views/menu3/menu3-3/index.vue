<template>
  <div class="container container-good">
    <div class="filter-wrap clear-top">
      ...
      <el-input v-model="queryParams.typeValue" placeholder="请输入关键字" class="search-input"></el-input>
    ...
    <el-table border row-key="goodsID" ref="multipleTable" :data="tableData3" style="width: 100%"
      ...
      <el-table-column :show-overflow-tooltip="true" prop="goodsPrice" label="成本价" align="center"
