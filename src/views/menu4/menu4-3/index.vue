        ...
        <!--  <el-table-column :show-overflow-tooltip="true" prop="levelName" label="客户级别" align="center">
         ...
         <el-table-column :show-overflow-tooltip="true" prop="test6" label="克隆状态" align="center">
          <template slot-scope="scope">
            ...
            <el-button type="warning" plain size="mini" style="margin-left:0" v-show="scope.row.cloneState == 2" @click="updateCloneState(scope.row)">审核通过</el-button>
         ...
         <el-table-column :show-overflow-tooltip="true" prop="test6" label="对接状态" align="center">
          <template slot-scope="scope">
            <el-button type="danger" plain size="mini" style="margin-left:0" v-show="scope.row.joinState == 1" @click="updateJoinState(scope.row)">申请对接</el-button>
            <el-button type="warning" plain size="mini" style="margin-left:0" v-show="scope.row.joinState == 2" @click="updateJoinState(scope.row)">申请通过</el-button>
            <el-button type="primary" plain size="mini" style="margin-left:0" v-show="scope.row.joinState == 3" @click="updateJoinState(scope.row)">审核失败</el-button>
            <el-button type="primary" plain size="mini" style="margin-left:0" v-show="scope.row.joinState == 4" @click="updateJoinState(scope.row)">拉黑
</el-button>
          </template>
        </el-table-column>
        <!--  <el-table-column :show-overflow-tooltip="true" prop="joinTime" label="对接时间" align="center" /> -->
      ...
      <el-form ref="updateAgentCloneForm" :model="updateAgentCloneForm" label-width="120px">
        <el-form-item label="是否允许供货：">
          <el-radio-group v-model="updateAgentCloneForm.cloneState">
            <el-radio :label="2">审核通过</el-radio>
            <el-radio :label="3">审核失败</el-radio>
            <el-radio :label="4">已克隆</el-radio>
            <el-radio :label="5">拉黑</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
